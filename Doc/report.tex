...
\begin{table}[!h] %!h forza la figura sotto il titolo
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{llll}
			...
			\begin{tabular}[c]{@{}l@{}}Istanza Attività \\ Formativa\end{tabular} & \begin{tabular}[c]{@{}l@{}}Insegnamento, Prova finale, Tirocinio o \\ Lingua che uno studente troverà effetti-\\ vamente nel suo piando di studi.\end{tabular} & Esame, Corso. & \begin{tabular}[c]{@{}l@{}}Docente, Percorso,\\ Attività Formativa\end{tabular} \\ \hline

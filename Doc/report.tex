...
\begin{table}[!h]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{ll}
			...
			\begin{tabular}[c]{@{}l@{}}Dati un Corso di Studi e una Coorte: trovare le Attività Formative attivate ordinate per anno\\ mostrando codice, nome, canale e anno accademico dell'istanza attività formativa con nome e\\ cognome del responsabile.\end{tabular} & Interrogazione \\ \hline
			\begin{tabular}[c]{@{}l@{}}Dati il codice di una Attività Formativa, il canale, l'anno accademico e il responsabile ritorna i \\ dettagli dell'Attività Formativa.\end{tabular} & Interrogazione \\ \hline
			...
			Inserimento di una nuova Attività Fomrativa. & Modifica \\ \hline
...
\begin{figure}[!h] %!h forza la figura sotto il titolo
	...
	\begin{center}
		\includegraphics[scale=0.5,angle=90]{../Schemas/ERdiagram.jpg}
	\end{center}
\end{figure}
...
\resizebox{\textwidth}{!}{%
	\begin{tabular}{llll}
		...
		\begin{tabular}[c]{@{}l@{}}Istanza Attività\\ Formativa\end{tabular} & \begin{tabular}[c]{@{}l@{}}Esame vero e proprio che gli studenti \\ \\ dovranno superare.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Attività Formativa, Canale, Anno Accademico,\\  Responsabile, Tipo Valutazione, Dipartimento, \\ a Frequenza Obbligatoria, Corso Singolo, Corso \\ Libero, Prerequisiti, Acquisire, Modalità Esame, \\ Criteri Valutazione, Contenuti, Attività, Materiali, \\ Testi, Lingua.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Attività Formativa, Canale, Anno \\ Accademico, Responsabile.\end{tabular} \\ \hline
		&  &  &  \\
		&  &  &  \\
		&  &  &  \\
		&  &  & 
...
\begin{figure} [!h] %!h forza la figura sotto il titolo
	\caption{Schema E-R completo}
	\begin{center}
		\includegraphics[scale=0.455,angle=90]{../Schemas/relationalmodel.png} %file va rinominato senza spazio senno viene plottato il nome file
	\end{center}
\end{figure}
